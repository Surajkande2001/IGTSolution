...
public class Demo3 {
    public static void main(String[] args) {    
        try {
            ...
            PreparedStatement pstmtInsert = con.prepareStatement("INSERT INTO employee VALUES(?,?,?,?,?)");
            ...
            do {
                ...
                switch (choice) {
                    ...
                    case 3:
                        PreparedStatement pstmtUpdate = con.prepareStatement("UPDATE employee SET salary = ? WHERE id = ?");
                    ...
                    case 4:
                        PreparedStatement pstmtDelete = con.prepareStatement("DELETE FROM employee WHERE id = ?");
